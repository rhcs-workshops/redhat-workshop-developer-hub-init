...
- Pincha en el bookmark del cluster de Developer Hub o https://backstage-backstage.apps.cluster-xdks5.xdks5.sandbox342.opentlc.com[aqui] para acceder a Red Hat Developer Hub. Accederás a la página principal con un usuario ya logueado.
