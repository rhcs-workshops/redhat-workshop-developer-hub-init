...
== Demo
- Pincha en el bookmark del cluster de Developer Hub o https://backstage-backstage.apps.cluster-n9qvt.n9qvt.sandbox1467.opentlc.com[aqui] para acceder a Red Hat Developer Hub. Accederás a la página de Developer Hub con un usuario ya logueado.
